...
DIR_INCLUDES = $(addprefix "-isystem",$(INCLUDES_$(@RD)))
...
# precedence.
CPPFLAGS = -MMD $(DIR_CPPFLAGS) $(DIR_INCLUDES) $(addprefix "-isystem",$(INCLUDES))

# List of library directories that all (or at least majority) needs
LIBDIRS :=
...
LDFLAGS = $(LDFLAGS_$(@)) $(addprefix -L,$(LIBDIRS_$(@RD))) $(addprefix -L,$(LIBDIRS))
